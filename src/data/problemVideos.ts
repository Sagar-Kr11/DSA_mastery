...
export const PROBLEM_VIDEOS: Record<string, ProblemVideo[]> = {
  ...
  "number-of-1-bits": [neet("5Km3utixwZs", "Number of 1 Bits"), { lang: "Java", yt: { kind: "video", id: "wLHhAHkID9M", channel: "AlgorithmsMadeEasy", title: "Number of 1 Bits — Java walkthrough" } }],
  "counting-bits": [neet("RyBM56RIWrM", "Counting Bits"), { lang: "Java", yt: { kind: "video", id: "J1hCybwTVVE", channel: "Prepflix", title: "Counting Bits — Java walkthrough" } }],
  "missing-number": [neet("WnPLSRLSANE", "Missing Number"), { lang: "Java", yt: { kind: "video", id: "NXwaiY9hGQU", channel: "Prepflix", title: "Missing Number — Java walkthrough" } }],
  ...
  "power-of-two": [{ lang: "Java", yt: { kind: "video", id: "bjRNBh0olIM", channel: "HackerHeap", title: "Power of Two — Java walkthrough" } }],
  "reverse-bits": [{ lang: "Java", yt: { kind: "video", id: "j5ImjESLcuc", channel: "Prepflix", title: "Reverse Bits — Java walkthrough" } }],
  "bitwise-and-of-numbers-range": [{ lang: "Java", yt: { kind: "video", id: "j3XRFREnPWI", channel: "XavierElon", title: "Bitwise AND of Numbers Range — Java walkthrough" } }],
  "divide-two-integers": [{ lang: "Java", yt: { kind: "video", id: "efpxjmVVdjI", channel: "AlgoDucky", title: "Divide Two Integers — Java walkthrough" } }],
