...
import type { YouTubeRef, Resource, Language, Problem, ProblemVideo } from "@/data/topics";
import { PROBLEM_VIDEOS } from "@/data/problemVideos";
...
import { ArrowLeft, BookOpen, Check, ChevronDown, ExternalLink, FileText, Play, Sparkles } from "lucide-react";
